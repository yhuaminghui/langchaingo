...
_**Note**: These docs are for [LangChainGo](https://github.com/yhuaminghui/langchaingo). For documentation on [the Python version](https://github.com/langchain-ai/langchain), [head here](https://python.langchain.com/docs)._
...
[Here](https://pkg.go.dev/github.com/yhuaminghui/langchaingo) you can find the API reference for all of the modules in LangChain, as well as full documentation for all exported classes and functions.
