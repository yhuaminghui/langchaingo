...
2. **Run the Example**: Enter the command:
   ```shell
   go run github.com/yhuaminghui/langchaingo/examples/ollama-completion-example@main
   ```
...
Here is the entire program (from [ollama-completion-example](https://github.com/yhuaminghui/langchaingo/blob/main/examples/ollama-completion-example/ollama_completion_example.go)).
