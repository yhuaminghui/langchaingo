...
```shell
go run github.com/yhuaminghui/langchaingo/examples/openai-completion-example@main
```
...
Here is the entire program (from [openai-completion-example](https://github.com/yhuaminghui/langchaingo/blob/main/examples/openai-completion-example/openai_completion_example.go)).
