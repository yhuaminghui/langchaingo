...
Here is the entire program (from [pgvector-vectorstore-example](https://github.com/yhuaminghui/langchaingo/blob/main/examples/pgvector-vectorstore-example/pgvector_vectorstore_example.go)):
