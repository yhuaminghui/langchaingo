...
> available [Documentation](https://pkg.go.dev/github.com/yhuaminghui/langchaingo).

Before you ask a question, it is best to search for existing [Issues](https://github.com/yhuaminghui/langchaingo/issues) that
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  components/versions (Make sure that you have read the [documentation](https://pkg.go.dev/github.com/yhuaminghui/langchaingo).
  If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  is not already a bug report existing for your bug or error in
  the [bug tracker](https://github.com/yhuaminghui/langchaingo/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/yhuaminghui/langchaingo/issues/new). (Since we can't be sure at this point whether it is a
...
- Make sure that you are using the latest version.
- Read the [documentation](https://pkg.go.dev/github.com/yhuaminghui/langchaingo) carefully and find out if the functionality is
  already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/yhuaminghui/langchaingo/issues) to see if the enhancement has already been suggested. If
