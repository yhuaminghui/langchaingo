...
import (
	...
	"github.com/yhuaminghui/langchaingo/llms/googleai"
	"github.com/yhuaminghui/langchaingo/llms/googleai/vertex"
)
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart(
			"https://github.com/yhuaminghui/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true",
		),
